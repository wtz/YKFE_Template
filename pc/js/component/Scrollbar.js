...
(function (global, factory) {
    ...
    Scrollbar.prototype.size = function() {
        ...
        var blw = isNaN(container.css('borderLeftWidth')) ? 0 : container.css('borderLeftWidth');  
        var bbw = isNaN(container.css('borderBottomWidth')) ? 0 : container.css('borderBottomWidth');
        track.css({
            right: container.innerWidth() * -1 + parseInt(blw) * -1,
            bottom: parseInt(container.css('marginBottom')) + parseInt(bbw),
